...
const Hero = () => {
  return (
    ...
    <motion.div
        ...
        viewport={{once:true}}
        id='home'
        className='min-h-screen flex item-center pt-20 pb-16 bg-linear-to-r from-dark-100 via-dark-300 to-dark-100 '
    >
        <div className='container mt-5 md:mt-0 mx-auto md:mx-15 px-6 flex flex-col md:flex-row items-center justify-between'>
            ...
            <div className='md:w-1/2 mb-10 md:mb-0'>
                ...
                <div className='flex space-x-4'>
                    <a href={assets.resume}  className='px-6 py-3 bg-purple rounded-lg font-medium hover:bg-purple-700 transition duration-300' download >My Resume</a>
